    ...
    <div style={{ display: "flex", alignItems: "center" }} className="md:hero mx-auto p-4 flex-col  justify-center flex lg:flex-row">
      ...
      <div className="md:hero-content flex flex-col">
        <div style={{lineHeight:"unset"}} className="text-center text-4xl md:pl-12 font-bold text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195] ">
          ⛏️ Start Mining XRP on SOL <br />and get free NFTs !
        ...
        <div className="flex flex-row justify-center">
          ...
          <a href="https://twitter.com/XRP_on_SOL"><svg className="w-14 h-14" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
