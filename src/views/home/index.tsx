  ...
  return (
    ...
    <div style={{ display: "flex", alignItems: "center" }} className="md:hero mx-auto p-4 flex-col  justify-center flex lg:flex-row">
      <div className="" style={{ borderRadius: "20px" }}>
        <img style={{ borderRadius: "20px" }} src="./mintbnb.png" alt="logo" className="xl:max-w-2xlxl h-[650px] object-cover" />
      ...
      <div className="md:hero-content flex flex-col">
        <div style={{lineHeight:"unset"}} className="text-center text-4xl md:pl-12 font-bold text-transparent bg-clip-text bg-gradient-to-tr from-[#9945FF] to-[#14F195] ">
          ⛏️ Start Mining BNB on SOL <br />and get free NFTs !
        ...
        <div className="flex flex-row justify-center">
          ...
          <a href="https://t.me/BNB_On_Solana">
        ...
        <h4 className="md:w-full text-center text-slate-300 my-2 lg:max-w-lg">
