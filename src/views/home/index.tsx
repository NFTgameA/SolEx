  ...
  return (
    ...
    <div style={{ display: "flex", alignItems: "center" }} className="md:hero mx-auto p-4 flex-col  justify-center flex lg:flex-row">
      <div className="" style={{ borderRadius: "20px" }}>
        <img style={{ borderRadius: "20px" }} src="./banner.png" alt="logo" className="xl:max-w-xl h-[450px] object-cover" />
      ...
      <div className="md:hero-content flex flex-col">
        ...
        <div className="flex flex-row">
          <a href="https://t.me/BNB_Solana">
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
          ...
          <a href="https://twitter.com/BNB_Solana"><svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
